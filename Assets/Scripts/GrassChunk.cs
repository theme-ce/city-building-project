    ...
    public void DrawTerrainMesh(Cell[,] grid)
    {
        ...
        for (int y = 0; y < m_size + 1; y++)
        {
            for (int x = 0; x < m_size + 1; x++)
            {
                ...
                #region FillCorner
                if (A == CellType.Grass && B != CellType.Grass && C != CellType.Grass && D != CellType.Grass) GenerateMeshTypeFillCorner(pos, 0);
                else if (A != CellType.Grass && B == CellType.Grass && C != CellType.Grass && D != CellType.Grass) GenerateMeshTypeFillCorner(pos, 90);
                else if (A != CellType.Grass && B != CellType.Grass && C != CellType.Grass && D == CellType.Grass) GenerateMeshTypeFillCorner(pos, 180);
                else if (A != CellType.Grass && B != CellType.Grass && C == CellType.Grass && D != CellType.Grass) GenerateMeshTypeFillCorner(pos, 270);
                #endregion
                #region Half
                else if (A == CellType.Grass && B != CellType.Grass && C == CellType.Grass && D != CellType.Grass) GenerateMeshTypeHalf(pos, 0);
                else if (A == CellType.Grass && B == CellType.Grass && C != CellType.Grass && D != CellType.Grass) GenerateMeshTypeHalf(pos, 90);
                else if (A != CellType.Grass && B == CellType.Grass && C != CellType.Grass && D == CellType.Grass) GenerateMeshTypeHalf(pos, 180);
                else if (A != CellType.Grass && B != CellType.Grass && C == CellType.Grass && D == CellType.Grass) GenerateMeshTypeHalf(pos, 270);
                #endregion
                #region Between
                else if (A == CellType.Grass && B != CellType.Grass && C != CellType.Grass && D == CellType.Grass) GenerateMeshTypeBetween(pos, 0);
                else if (A != CellType.Grass && B == CellType.Grass && C == CellType.Grass && D != CellType.Grass) GenerateMeshTypeBetween(pos, 90);
                #endregion
                #region EmptyCorner
                else if (A == CellType.Grass && B == CellType.Grass && C == CellType.Grass && D != CellType.Grass) GenerateMeshTypeBlankCorner(pos, 0);
                else if (A == CellType.Grass && B == CellType.Grass && C != CellType.Grass && D == CellType.Grass) GenerateMeshTypeBlankCorner(pos, 90);
                else if (A != CellType.Grass && B == CellType.Grass && C == CellType.Grass && D == CellType.Grass) GenerateMeshTypeBlankCorner(pos, 180);
                else if (A == CellType.Grass && B != CellType.Grass && C == CellType.Grass && D == CellType.Grass) GenerateMeshTypeBlankCorner(pos, 270);
                #endregion
                #region Normal
